...
describe BackupJob do
  it "should build a valid main rsync command line" do
    ...
    expect(j.main_rsync).to be == "/usr/bin/pfexec rsync --stats -aHRW --numeric-ids --timeout=3600 --delete-excluded --exclude=.zfs -e 'ssh -p 22' --filter='protect /home' --include=/ --exclude=/home --exclude=/backup server1.example.com:/ /backup/server1.example.com/"
  end
  ...
  it "should store a list of rsyncs" do
    ...
    j.rsyncs.first.should == "/usr/bin/pfexec rsync --stats -aHRW --numeric-ids --timeout=3600 --delete-excluded --exclude=.zfs -e 'ssh -p 22' --filter='protect /home' --include=/ --exclude=/backup server1.example.com://home/a* /backup/server1.example.com/"
    j.rsyncs.last.should == "/usr/bin/pfexec rsync --stats -aHRW --numeric-ids --timeout=3600 --delete-excluded --exclude=.zfs -e 'ssh -p 22' --filter='protect /home' --include=/ --exclude=/backup server1.example.com://home/9* /backup/server1.example.com/"
  end
  ...
  it "should store more rsyncs if the depth is 2" do
    ...
    j.rsyncs.first.should == "/usr/bin/pfexec rsync --stats -aHRW --numeric-ids --timeout=3600 --delete-excluded --exclude=.zfs -e 'ssh -p 22' --filter='protect /home' --include=/ --exclude=/backup server1.example.com://home/a*/a* /backup/server1.example.com/"
    j.rsyncs.last.should == "/usr/bin/pfexec rsync --stats -aHRW --numeric-ids --timeout=3600 --delete-excluded --exclude=.zfs -e 'ssh -p 22' --filter='protect /home' --include=/ --exclude=/backup server1.example.com://home/9*/9* /backup/server1.example.com/"
  end
